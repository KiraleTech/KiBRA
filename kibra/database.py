...
DB_ITEMS = {
    ...
    'interior_ipv6_ll': [str, None, lambda x: True, False, False],
    ...
    'ncp_channel': [int, None, lambda x: True, True, False],
    ...
    'ncp_mac': [str, None, lambda x: True, False, False],
    'ncp_name': [str, DEF_DONGLENAME, lambda x: True, True, True],
    'ncp_netkey': [str, None, lambda x: True, True, False],
    'ncp_netname': [str, None, lambda x: True, True, False],
    'ncp_outband': [str, None, lambda x: True, True, False],
    'ncp_panid': [str, None, lambda x: True, True, False],
    'ncp_prefix': [str, None, lambda x: True, True, False],
    'ncp_rloc': [str, None, lambda x: True, False, False],
    'ncp_role': [str, 'leader', lambda x: True, True, False],
    ...
    'ncp_xpanid': [str, None, lambda x: True, True, False],
