...
DB_ITEMS = {
    ...
    'dongle_channel': [int, None, lambda x: True, False, False],
    'dongle_clear': [int, None, lambda x: True, False, False],
    'dongle_commcred': [str, None, lambda x: True, False, True],
    'dongle_eid': [str, None, lambda x: True, False, False],
    'dongle_emac': [str, None, lambda x: True, False, False],
    'dongle_ll': [str, None, lambda x: True, False, False],
    'dongle_mac': [str, None, lambda x: True, False, False],
    'dongle_name': [str, None, lambda x: True, False, True],
    'dongle_netkey': [str, None, lambda x: True, False, False],
    'dongle_netname': [str, None, lambda x: True, False, False],
    'dongle_outband': [str, None, lambda x: True, False, False],
    'dongle_panid': [str, None, lambda x: True, False, False],
    'dongle_prefix': [str, None, lambda x: True, False, False],
    'dongle_rloc': [str, None, lambda x: True, False, False],
    'dongle_role': [str, None, lambda x: True, False, False],
    'dongle_serial': [str, None, lambda x: True, False, True],
    'dongle_sjitter': [str, None, lambda x: True, False, True],
    'dongle_status': [str, None, lambda x: True, False, False],
    'dongle_xpanid': [str, None, lambda x: True, False, False],
    'dua_prefix': [str, None, lambda x: True, False, False],
